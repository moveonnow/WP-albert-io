...
This plugin provides the `voting_wp_pagenavi()` template tag which generates fancy pagination links. See the [installation instructions](http://wordpress.org/extend/plugins/wp-pagenavi/installation/) for using it in your theme.
...
`<?php voting_wp_pagenavi( array( 'type' => 'multipart' ) ); ?>`
...
`<?php voting_wp_pagenavi( array( 'options' => Voting_PageNavi_Core::$options->get_defaults() ) ); ?>`
...
* added $query arg to voting_wp_pagenavi()
* updated translations
* [more info](http://scribu.net/wordpress/wp-pagenavi/wpn-2-74.html)

= 2.73 (2010-08-17) =
* added $options arg to voting_wp_pagenavi()
* updated scbFramework
...
* new: Added $before And $after Function Arguments To voting_wp_pagenavi();
