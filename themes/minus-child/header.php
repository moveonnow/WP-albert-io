...
<div class="flex-cnt">
	<div id="floating_menu" <?php echo $float_menu_attr; ?>>
		...
		?>
		<header class="clear <?php echo $header_class; ?>" style="<?php echo $header_style; ?>">
			<?php tha_header_top(); ?>
			...
			<div class="clear top-header">
				...
				<div class="small-logo">
					<a class="lg" href="<?php echo home_url( '/' ); ?>">
						<img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/small-logo.svg'; ?>" />
					</a>
				</div>
				...
				<div class="buttons">
					...
					<?php
						...
						if ( '' != get_theme_mod( 'explore_albert_link', 'https://www.albert.io/test-prep/?utm_campaign=blog-header-button&utm_medium=blog&utm_source=blog' ) ) {
							$explore_albert_link = get_theme_mod( 'explore_albert_link', 'https://www.albert.io/test-prep/?utm_campaign=blog-header-button&utm_medium=blog&utm_source=blog' );
						}

						if ( '' != get_theme_mod( 'school_resources_link', 'https://www.albert.io/blog/school-resources/?utm_campaign=blog-header-button&utm_medium=blog&utm_source=blog' ) ) {
							$school_resources_link= get_theme_mod( 'school_resources_link', 'https://www.albert.io/blog/school-resources/?utm_campaign=blog-header-button&utm_medium=blog&utm_source=blog' );
						}

						if ( '' != get_theme_mod( 'school_resources_text', 'School Resources' ) ) {
							$school_resources_text = get_theme_mod( 'school_resources_text', 'School Resources' );
						}

						if ( '' != get_theme_mod( 'explore_albert_text', 'Explore Albert' ) ) {
							$explore_albert_text = get_theme_mod( 'explore_albert_text', 'Explore Albert' );
						}

					?>

					<a class="school-button btn btn-primary" href="<?php echo $school_resources_link; ?>"><?php echo $school_resources_text; ?></a>
					<a class="explore-button btn btn-secondary" href="<?php echo $explore_albert_link; ?>"><?php echo $explore_albert_text; ?></a>
				</div>
				...
				<div class="h-i">
					...
					<div class="mhl" id="nav_right">
						...
						<?php if ( has_nav_menu( "primary" ) ): ?>
							...
							<?php wp_nav_menu( array( 'container' => 'nav', 'depth' => 0, 'theme_location' => 'mobile-menu', 'container_class' => "right", 'menu_class' => 'mobile-menu menu', 'walker' => new thrive_custom_menu_walker() ) ); ?>
